...
$(document).ready(function() {
  ...
  if (typeof API_Key === "undefined") {
    $("body").html("No API Key found or load! Fucking kill me<br>Right-click on the script in Streamlabs and select \"Insert API Key\"");
...
function connectWebsocket() {
  ...
  socket.onopen = function() {
    ...
    var auth = {
      author: "Mikey",
      website: "http://www.twitch.tv/big_kage",
      api_key: API_Key,
      events: [
